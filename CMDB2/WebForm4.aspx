...
<h4>App To Infra Relationship</h4>
    <asp:GridView ID="GridView1" runat="server" DataKeyNames="Transaction_ID" DataSourceID="SqlDataSource1" Visible="true"
    CssClass="GridView1" GridLines="none" CellPadding="-1" CellSpacing="-1" ShowFooter="True" AllowSorting="True" AutoGenerateColumns="false" AutoGenerateDeleteButton="True" AutoGenerateEditButton="True">
...
<div class="table-wrapper">
    <h4>Infra To Infra Relationship</h4>
                <asp:GridView ID="GridView2" runat="server" DataKeyNames="Transaction_ID" DataSourceID="SqlDataSource2" Visible="true"  
   CssClass="GridView1" GridLines="none" CellPadding="-1" CellSpacing="-1" ShowFooter="True" AllowSorting="True" AutoGenerateColumns="false" AutoGenerateDeleteButton="True" AutoGenerateEditButton="True">
        <FooterStyle BackColor="#C6C3C6" ForeColor="Black" />
    <HeaderStyle Font-Size="7pt" Width="400px" BackColor="#4A3C8C" Font-Bold="True" ForeColor="#E7E7FF"></HeaderStyle>
    <PagerStyle BackColor="#C6C3C6" ForeColor="Black" HorizontalAlign="Right" />
    ...
    <SortedDescendingHeaderStyle BackColor="#33276A" />
        <Columns>
                       ...
                       <div class="table-wrapper">
                           <asp:GridView ID="GridView3" runat="server" AutoGenerateColumns="False" DataKeyNames="CR_Number" DataSourceID="SqlDataSource3" CssClass="GridView1" GridLines="none" CellPadding="-1" CellSpacing="-1" ShowFooter="True" AllowSorting="True"  AutoGenerateDeleteButton="True" AutoGenerateEditButton="True">
                               <Columns>
