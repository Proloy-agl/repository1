...
<%--<div class="table-wrapper">
    <h4>Infra To Infra Relationship</h4>
                <asp:GridView ID="GridView2" DataKeyNames="Transaction_ID"   DataSourceID="SqlDataSource2" runat="server" Visible="false"  
   CssClass="GridView1" GridLines="none" CellPadding="-1" CellSpacing="-1" ShowFooter="True" AllowSorting="True" AutoGenerateColumns="false" AutoGenerateDeleteButton="True" AutoGenerateEditButton="True">
        <FooterStyle BackColor="#C6C3C6" ForeColor="Black" />
    <HeaderStyle Font-Size="7pt" Width="400px" BackColor="#4A3C8C" Font-Bold="True" ForeColor="#E7E7FF"></HeaderStyle>
    <PagerStyle BackColor="#C6C3C6" ForeColor="Black" HorizontalAlign="Right" />
   ...
   CssClass="GridView1" GridLines="none" CellPadding="-1" CellSpacing="-1" ShowFooter="True" AllowSorting="True"  AutoGenerateDeleteButton="True" AutoGenerateEditButton="True">
        <FooterStyle BackColor="#C6C3C6" ForeColor="Black" />
    <HeaderStyle Font-Size="7pt" Width="400px" BackColor="#4A3C8C" Font-Bold="True" ForeColor="#E7E7FF"></HeaderStyle>
    <PagerStyle BackColor="#C6C3C6" ForeColor="Black" HorizontalAlign="Right" />
    <RowStyle BackColor="#DEDFDE" ForeColor="Black" />
...
DeleteCommand="DELETE FROM [Audit_Decomission] where [Transaction_ID]=@Transaction_ID">
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:CMDB_DB_DEVConnectionString %>" SelectCommand="SELECT * FROM [Audit_Relationship_App_to_Infra]" UpdateCommand="UPDATE [Audit_Relationship_App_to_Infra] SET [App_CI_Name]=@App_CI_Name,[Infra_CI_Name]=@Infra_CI_Name where [Transaction_ID]=@Transaction_ID  " DeleteCommand="DELETE FROM [Audit_Relationship_App_to_Infra] where [Transaction_ID]=@Transaction_ID">
                  ...
                  <asp:Button ID="Button2" runat="server" CssClass="button1" Text="Submit and Close" OnClick="Button2_Click1"  />
       
                  <asp:LinkButton ID="LinkButton1" runat="server" PostBackUrl="http://aglitremedyuat.agl.com.au:8080/arsys " OnClick="Button2_Click1">LinkButton</asp:LinkButton>
