...
<body>
  ...
  <legend class="heading1">Count details for the CR </legend>
   ...
   CssClass="GridView1" EmptyDataText="No Corresponding  Record Present for the CR" GridLines="none" CellPadding="-1" CellSpacing="-1" ShowFooter="True" AllowSorting="True"  AutoGenerateDeleteButton="True" AutoGenerateEditButton="False">
